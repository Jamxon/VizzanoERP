...
Route::prefix('ceo')->middleware('role:ceo')->group(function () {
    ...
    Route::post('groups3', [CasherController::class, 'getGroupsOrdersEarnings3']);
    ...
    Route::get('dailyPayments/daily', [DailyPaymentController::class, 'showDailyPaymentWithDay']);
...
Route::prefix('superhr')->middleware('role:superhr')->group(function () {
    Route::get('export-attendance/excel', [CasherController::class, 'exportEmployeeAttendance']);
